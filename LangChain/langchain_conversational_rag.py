...
#Prompt template
prompt_template = ChatPromptTemplate.from_messages([("human", "Tell me a short joke about {topic}")]
)
...
# LLM Message
system_msg = SystemMessage(content="You are a helpful assistant that provides information about programming languages.")
